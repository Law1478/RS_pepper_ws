...
: ${AMENT_CURRENT_PREFIX:="/home/hayden/ros_ws/install/pepper_robot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pepper_robot_description/environment/pepper_robot_description.sh"
